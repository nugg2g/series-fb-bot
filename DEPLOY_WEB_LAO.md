...
1. **PIN Code Lock**: ເມື່ອເຂົ້າເວັບຄັ້ງທຳອິດ ຫຼື ຫຼັງຈາກກົດລັອກ, ລະບົບຈະຖາມຫາລະຫັດ PIN (ຄ່າເລີ່ມຕົ້ນແມ່ນ `8888`).
   - ຖ້າກົດລະຫັດຜິດເກີນ 5 ຄັ້ງ, ລະບົບຈະ Block IP ນັ້ນ 5 ນາທີ (Anti-Brute Force).
